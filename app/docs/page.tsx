    ...
    <div className="min-h-screen bg-[#07090E] flex items-center justify-center pt-20">
      <div className="text-center px-6">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-white mb-6 tracking-tighter">Documentation</h1>
          <p className="text-xl text-white/50 font-medium max-w-lg mx-auto leading-relaxed">
            Our comprehensive guides and support docs are currently being written to help you get the most out of SchoolFoundry.
          </p>
          <div className="mt-12">
